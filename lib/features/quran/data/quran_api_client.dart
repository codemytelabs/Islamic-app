...
class QuranApiClient {
  ...
  Future<List<QuranVerse>> fetchVersesByChapter(int chapterId) async {
    final uri = Uri.parse(
      'https://api.quran.com/api/v4/verses/by_chapter/$chapterId?language=en&words=false&per_page=300&translations=131&tafsirs=169&fields=text_uthmani,verse_key,verse_number,page_number',
    );
  ...
  Future<List<QuranVerse>> fetchVersesByPage(int pageNumber) async {
    final uri = Uri.parse(
      'https://api.quran.com/api/v4/verses/by_page/$pageNumber?language=en&words=false&per_page=300&translations=131&tafsirs=169&fields=text_uthmani,verse_key,verse_number,page_number',
    );
